...
<div class="digital-dairy-black-bar" style="background:url(<?php bloginfo('template_url'); ?>/images/desktop_top.jpg) 0 0 no-repeat">
	<div class="container-fluid">
    <div class="row">
    	<div class="col-md-3">
        	<span class="brand-icon"><img src="<?php bloginfo('template_url'); ?>/images/logo-icon.png" alt="Next"></span>
            <span class="digital-dairy-title">Digital Diary</span>
        </div>
        <div class="col-md-8">
        	<p>The Digital Diary is the No. 1 online resource dedicated to bringing the latest Digital Business Transformation content to C-Suite executives from North America’s most progressive industries.</p>
        </div>
     </div>
    </div>
</div>
<!-- digital-dairy-black-bar end here -->
        	...
        	<div class="row">
            	<div class="col-md-12">
                	   <div class="category-white-sec">
                            ...
                            <div class="cate-select mobile-show">
                            	<select>
                                	<option>All</option>
                                    <option>#MillenniumLife</option>
                       		...
                       		<ul class="category-menu mobile-hide">
  ...
  <div class="grey-three-col-sec">
  		<div class="container">
        	<div class="row">
                ...
                <div class="col-md-3 grey-mid-col">
                	<p>Reach thousands of C-Level
Executives every month. </p>
                </div>
                <div class="col-md-5">
                	<a href="<?php echo site_url(); ?>/contact-us" class="btn black-btn">Click here to request more information <i class="lft-btn-arrow"><img src="<?php bloginfo('template_url'); ?>/images/white-rt-arrow.png" alt="Next"> </i></a>
                </div>
            </div>
  		</div>
  </div>
    ...
    <div class="grey-three-col-sec">
  		<div class="container">
        	<div class="row">
                ...
                <div class="col-md-4">
                	<a href="<?php echo site_url(); ?>/contact-us" class="btn black-btn">Contact Digital Diary <i class="lft-btn-arrow"><img src="<?php bloginfo('template_url'); ?>/images/white-rt-arrow.png" alt="Next"> </i></a>
                </div>
            </div>
  		</div>
  </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <a href="<?php echo site_url(); ?>/contact-us" class="overlay-link"></a>
          ...
          <a href="<?php echo site_url(); ?>/contact-us" class="lft-arrow"><img src="<?php bloginfo('template_url'); ?>/images/white-rt-arrow.png" alt=""></a> </div>
      </div>
    </div>
  </div>
